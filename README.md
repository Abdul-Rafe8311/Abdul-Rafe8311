...
- Designed an **18-table relational schema for BuildLink**, a construction marketplace, and wired it end-to-end with Prisma, MySQL, NextAuth, and Cloudinary. Spent real time debugging seed scripts and connection pooling — the unglamorous database plumbing that decides whether an app actually works in production.
...
- Built **NUST Cafe Rater**, a campus web app for rating on-campus cafes, with NUST email auth, one-review-per-user-per-cafe logic, and toast notifications.
...
| **BuildLink** | Construction marketplace | Next.js 14 · Prisma · MySQL |
| **NUST Cafe Rater** | Campus review app | Supabase · NUST email auth |
| **AI News Summariser** | News summariser | JavaFX · Gemini API |
| **CipherStack** | Visual encryption builder (hackathon) | React |
...
> Still early in the journey — but every project here taught me something a course couldn't.
